...
const FormSelect: FC<Props> = ({ label, name, options, errors, control, icon: Icon, onChange }) => {
  const customStyles = {
  ...
  const selectOptions = options.map((v) => ({ label: v, value: v }));
        ...
        <Controller
          ...
          render={({
            ...
            <Select
              ...
              name={name}
              value={selectOptions?.find((option) => value === option.value) || null}
